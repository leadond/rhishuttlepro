...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3 my-4", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-lg bg-slate-800 flex items-center justify-center mt-0.5 flex-shrink-0">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
             ...
             {isUser && (
                <div className="h-8 w-8 rounded-lg bg-slate-200 text-slate-700 flex items-center justify-center mt-0.5 flex-shrink-0">
